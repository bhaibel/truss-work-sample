  ...
  RSpec.describe DataSet do
    it "can be built from a CSV string", focus: true do
      ...
      aggregate_failures do
        expect(data_set.rows.first.timestamp_as_est).to eq(DateTime.strptime("4/1/11 11:00:00 AM -5:00", "%m/%d/%y %l:%M:%S %p %z"))
    ...
    it "can be converted to a CSV string" do
      ...
      expect(data_set.to_csv_string).to eq <<~EOT
        Timestamp,Address,ZIP,FullName,FooDuration,BarDuration,TotalDuration,Notes
        2011-04-01T08:00:00-08:00,"123 4th St, Anywhere, AA",94121,MONKEY ALBERTO,5012.123,5553.123,10565.246,I am the very model of a modern major general
      EOT
    end
